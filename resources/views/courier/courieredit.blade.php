...
<head>
  ...
  <title>Estore Admin's Page | Edit Courier</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> Admin <small>Edit Courier</small></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/admin/home">Home</a></li>
              <li class="breadcrumb-item"><a href="/admin/crud">CRUD Pages</a></li>
              <li class="breadcrumb-item"><a href="/couriers">Courier's Table</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="col-md-8">
                <div class="component">
                    ...
                    <div class="card-footer" align="center">
                        <button class="btn btn-success fa fa-pencil" type="submit" onclick="return confirm('Are you sure want to change the data?')"> Edit</button>
                    </div>
                        </form>
                    @if (count($errors) > 0)
