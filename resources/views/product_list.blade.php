                ...
                <div class="col-md-8">
                    <div class="product_list">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="{{ asset('/img/categori/product2.png') }}" alt="" class="img-fluid">
                                    <h3> <a href="#">Too Cool for Mondays Croptop</a> </h3>
                                    <p>Rp.149.999</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="{{ asset('/img/categori/product3.png') }}" alt="" class="img-fluid">
                                    <h3> <a href="#">Yellow Braided Sweatshirt</a> </h3>
                                    <p>From Rp.219.999</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    ...
                                    <h3> <a href="#">This Grey Sweatshirt</a> </h3>
                                    <p>Rp.239.999</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    ...
                                    <h3> <a href="#">Black Short Sweatpants</a> </h3>
                                    <p>Rp.129.999</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-6">
                                <div class="single_product_item">
                                    <img src="{{ asset('/img/categori/product6.png') }}" alt="" class="img-fluid">
                                    <h3> <a href="#">This Jeans Women's Blazer</a> </h3>
                                    <p>Rp.139.999</p>
                                </div>
                            </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="client_review_slider owl-carousel">
                        <div class="single_client_review">
                            ...
                            <p>Clothing dari Estore ini enak banget loh! Kain fabric nya buat pewe untuk dipake.</p>
                            <h5>Rudi Tabuti</h5>
                        </div>
                        <div class="single_client_review">
                            <div class="client_img">
                            ...
                            <p>I shopped at Estore once. I'll try their's cloth and it's so good!</p>
                            <h5>Freddy</h5>
                        </div>
                        <div class="single_client_review">
                            <div class="client_img">
                            ...
                            <p>Baju Estore ini enak banget buat dipakai, halus banget, dan gak gampang luntur</p>
                            <h5>Ferdi</h5>
                        </div>
                    </div>
                </div>
