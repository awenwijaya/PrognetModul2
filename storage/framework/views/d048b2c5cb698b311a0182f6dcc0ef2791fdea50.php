...
<head>
<title>Admin</title>
<link rel="shortcut icon" href="<?php echo e(asset('assets/User/images/shirt.png')); ?>" type="image/x-icon">
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false); function hideURLbar(){ window.scrollTo(0,1); } </script>
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<link href="<?php echo e(asset('assets/Admin/css/bootstrap.css')); ?>" rel="stylesheet" type="text/css" media="all">
<!-- Custom Theme files -->
<link href="<?php echo e(asset('assets/Admin/css/style.css')); ?>" rel="stylesheet" type="text/css" media="all"/>
<!--js-->
							...
							<div class="profile_details_left"><!--notifications of menu start -->
								<ul class="nofitications-dropdown">
									...
									<li class="dropdown head-dpdn">
                						...
                						?>
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-bell"></i><span class="badge blue"><?php echo e($notif_count); ?></span></a>
										<ul class="dropdown-menu">
											<li>
												<div class="notification_header">
													<h3>You have <?php echo e($notif_count); ?> new notification</h3>
												</div>
											</li>
											<li>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<span class="prfil-img"><img src="/uploads/avatars/<?php echo e(Auth::user()->profile_image); ?>" style="width:50px; height:50px; position:absolute; top:1px; left:-30px; border-radius:50%" alt=""> </span> 
												<div class="user-name">
...
<script>
	$(document).ready(function(e){
		$(".status").click(function(e){
		  ...
		  jQuery.ajax({
				url: "<?php echo e(url('/admin/transaksi/sort')); ?>",
				method: 'post',
				data: {
  ...
  <script>
    ...
    var options = {
        ...
        title: {
            text: "Grafik Jumlah Transaksi Perbulan <?php echo e(date('Y')); ?>"              
        },
        data: [              
        {
            type: "column",
    ...
    function creteChart(tahun, ttlTahun, judul = ''){
      ...
      jQuery(document).ready(function(e){
          ...
          jQuery('#bulan').change(function(e){
                jQuery.ajax({
                    url: "<?php echo e(url('/report-bulan')); ?>",
                    method: 'post',
                    data: {
                        _token: $('#signup-token').val(),
                        bulan: $('#bulan').val(),
          ...
          jQuery('#tahun').change(function(e){
                jQuery.ajax({
                    url: "<?php echo e(url('/report-tahun')); ?>",
                    method: 'post',
                    data: {
                        _token: $('#signup-token').val(),
                        bulan: $('#bulan').val(),
...
<?php echo $__env->make('layouts.sidebaradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\awenh\Documents\College Stuffs\PRAKTIKUM\PRAKTIKUM PROGNET\WEB PRAK. PROGNET\Praktikum Prognet Experiment - Percobaan 2 - Copy - Copy (2)\resources\views/layouts/main.blade.php ENDPATH**/ ?>