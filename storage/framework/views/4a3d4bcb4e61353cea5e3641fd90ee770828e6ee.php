                       ...
                       <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left d-flex">
                                    <div class="flag">
                                        <img src="<?php echo e(asset('/img/icon/header_icon.png')); ?>" alt="">
                                    </div>
                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-1 col-lg-1 col-md-1 col-sm-3">
                                <div class="logo">
                                  <a href="/"><img src="<?php echo e(asset('/img/logo/logo.png')); ?>" alt=""></a>
                                </div>
                            </div>
    ...
    <main>
        ...
        <div class="slider-area ">
            ...
            <div class="slider-active">
                <div class="single-slider slider-height" data-background="<?php echo e(asset('/img/hero/h1_hero.jpg')); ?>">
                    <div class="container">
                        <div class="row d-flex align-items-center justify-content-between">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 d-none d-md-block">
                                <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                    <img src="<?php echo e(asset('/img/hero/hero_man.png')); ?>" alt="">
                                </div>
                            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6">
                        <div class="single-category mb-30">
                            <div class="category-img">
                                <img src="<?php echo e(asset('/img/categori/cat1.jpg')); ?>" alt="">
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="single-category mb-30">
                            <div class="category-img">
                                <img src="<?php echo e(asset('/img/categori/cat3.jpg')); ?>" alt="">
                                <div class="category-caption">
                                    <h2>Men`s Cloth</h2>
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="<?php echo e(asset('/img/categori/product1.png')); ?>" alt="">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="<?php echo e(asset('/img/categori/product2.png')); ?>" alt="">
                                    </div>
                                    <div class="product-caption">
                                        <div class="product-ratting">
                                            <i class="far fa-star"></i>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="<?php echo e(asset('/img/categori/product3.png')); ?>" alt="">
                                        <div class="new-product">
                                            <span>New</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="<?php echo e(asset('/img/categori/product4.png')); ?>" alt="">
                                    </div>
                                    <div class="product-caption">
                                        <div class="product-ratting">
                                            <i class="far fa-star"></i>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="<?php echo e(asset('/img/categori/product5.png')); ?>" alt="">
                                    </div>
                                    <div class="product-caption">
                                        <div class="product-ratting">
                                            <i class="far fa-star"></i>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-60">
                                    <div class="product-img">
                                        <img src="<?php echo e(asset('/img/categori/product6.png')); ?>" alt="">
                                        <div class="new-product">
                                            <span>New</span>
                                        </div>
                                    </div>
        ...
        <div class="best-product-area lf-padding" >
           <div class="product-wrapper bg-height" style="background-image: url('<?php echo e(asset('/img/categori/card.png')); ?>')">
                <div class="container position-relative">
                    <div class="row justify-content-between align-items-end">
                        <div class="product-man position-absolute  d-none d-lg-block">
                            <img src="<?php echo e(asset('/img/categori/card-man.png')); ?>" alt="">
                        </div>
           ...
           <div class="shape bounce-animate d-none d-md-block">
               <img src="<?php echo e(asset('/img/categori/card-shape.png')); ?>" alt="">
           </div>
        </div>
        <!-- Best Product End-->
                ...
                <div class="row d-flex justify-content-between align-items-end">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        ...
                        <div class="best-left-img mb-30 d-none d-sm-block">
                            <img src="<?php echo e(asset('/img/collection/collection1.png')); ?>" alt="">
                        </div>
                    </div>
                    <!-- Mid Img -->
                     <div class="col-xl-2 col-lg-2 d-none d-lg-block">
                        <div class="best-mid-img mb-30 ">
                            <img src="<?php echo e(asset('/img/collection/collection2.png')); ?>" alt="">
                        </div>
                    </div>
                    <!-- Riht Caption -->
        ...
        <div class="latest-wrapper lf-padding">
            <div class="latest-area latest-height d-flex align-items-center" data-background="assets/img/collection/latest-offer.png">
                ...
                <!-- man Shape -->
                <div class="man-shape">
                    <img src="<?php echo e(asset('/img/collection/latest-man.png')); ?>" alt="">
                </div>
            </div>
        </div>
        <!-- Latest Offers End -->
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="gallery-items">
                            <img src="<?php echo e(asset('/img/gallery/gallery1.jpg')); ?>" alt="">
                        </div> 
                        <div class="gallery-items">
                            <img src="<?php echo e(asset('/img/gallery/gallery2.jpg')); ?>" alt="">
                        </div>
                        <div class="gallery-items">
                            <img src="<?php echo e(asset('/img/gallery/gallery3.jpg')); ?>" alt="">
                        </div>
                        <div class="gallery-items">
                            <img src="<?php echo e(asset('/img/gallery/gallery4.jpg')); ?>" alt="">
                        </div>
                        <div class="gallery-items">
                            <img src="<?php echo e(asset('/img/gallery/gallery5.jpg')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\Users\awenh\Documents\College Stuffs\PRAKTIKUM\PRAKTIKUM PROGNET\WEB PRAK. PROGNET\Praktikum Prognet Experiment - Percobaan 2 - Copy - Copy (2)\resources\views/index.blade.php ENDPATH**/ ?>